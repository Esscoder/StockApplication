...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(10, 10, 211, 121));
        stockLayout = new QVBoxLayout(widget);
        ...
        selectedStockSymbol = new QLineEdit(widget);
